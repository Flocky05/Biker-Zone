        ...
        <div className="bg-orange-200 p-20">
            <h2 className="text-center text-3xl font-bold p-7 uppercase">Contract <span className="text-red-500">with</span> use</h2>
                <form action="">
                    ...
                    <textarea  placeholder="enter your problem" className="border-2 rounded-md p-4 w-full lg:w-2/4 h-32"></textarea>
                    <p className="text-white text-xl">Enter your mail</p>
                    <input type="text" placeholder="enter your mail" className="p-2 rounded-md border  w-full lg:w-2/4"/>
                    <br />
